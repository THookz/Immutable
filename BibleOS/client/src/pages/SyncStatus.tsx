    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-slate-100">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-slate-600">Sync Status & Management</p>
              </div>
            </div>
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            <h2 className="text-3xl font-bold text-slate-900 mb-2">Sync Status</h2>
            <p className="text-slate-600">
              Monitor your offline data synchronization and manage background sync settings.
            </p>
          </div>
